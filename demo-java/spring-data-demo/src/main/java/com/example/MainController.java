...
public class MainController {
	 ...
	 * @Async
	 * 
	 * @GetMapping(path = "/test") public Future<Boolean> sendMail() throws
	 * InterruptedException { System.out.println("sending mail..");
	 * trigger.set(true); kickStart(); System.out.println(
	 * "sending mail completed"); return new AsyncResult<Boolean>(true); }
	 */
	...
	public void stopLoading() throws InterruptedException {
